...
def main():
    ...
    # Optional: Try to print model info (requires ultralytics-thop)
    # This is NOT required for training, only for profiling
    try:
        print(f"\nModel profiling:")
        model.info()
    except Exception as e:
        print(f"\nNote: Model profiling skipped (ultralytics-thop not installed)")
        print(f"This is fine - profiling is optional and doesn't affect training.")
